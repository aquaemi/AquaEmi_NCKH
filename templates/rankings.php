        ...
        <section>
            ...
            <div class = "content" id = "content">
                <div class = "small_navigation" id = "small_navigation">
                    <div class = "news_navigation" id = "news_navigation"><a href = "news" style = "color:#000; text-decoration: none;">News</a></div>
                    <div class = "rankings_navigation" id = "rankings_navigation"><a href = "rankings" style = "color:#00C986; text-decoration: none;">Rankings</a></div>
                </div>
